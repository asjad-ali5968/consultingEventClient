...
export const homeData: HomePageData = {
  heroData: {
    slides: [
      ...
      },
      {
        ...
        description:
          "We believe that it is all about the <span>big dreams</span> and the small details!",
      },
    ],
  },
  ...
  moreInfoData: {
    eyebrow: "Tailored Event Services",
    title: "More Info",
    description:
      "Elegant planning and design support crafted to keep your celebration seamless, stylish, and stress-free.",
    itemEyebrow: "Signature Service",
    items: [
      {
        title: "Partial Planning",
        subtitle: "Enjoy the Moment",
        description:
          "When it comes to Partial Planning, I'll assist you every step of the way so you won't have to worry about a thing, except showing up. If you'd like to learn more about the services I offer, please contact me today.",
      },
      {
        title: "Event Decoration",
        subtitle: "Satisfaction Guaranteed",
        description:
          "Make your events worthwhile with BEASTY EVENTS DECOR. I'll take care of all the logistics, so you can just sit back and enjoy the day. If you'd like to learn more about my Event Decoration services, all you have to do is to contact me to discuss package prices.",
      },
      {
        title: "Event Management",
        subtitle: "Impactful Experiences",
        description:
          "From a concept to the day of celebration, your event deserves all the care in the world. With my Event Management services, you can be sure your next event will be stunning, organized, and enjoyable. Get in touch today for a free consultation.",
      },
    ],
  },
